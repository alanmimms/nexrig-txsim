...
int main() {
  ...
  std::vector<BandFilter> bands = {
    BandFilter("160m", 1.8, 2.0, 390, 330*2, 390, 18000, 18000),
    BandFilter("80m",  3.5, 4.0, 180, 160*2, 180, 10000, 10000),
    BandFilter("60m",  5.3, 5.4, 150, 240*2, 150, 6800, 5800),
    BandFilter("40m",  7.0, 7.3, 100, 100*2, 100, 4700, 4700),
    BandFilter("30m",  10.1, 10.15, 82, 68*2, 82, 3300, 3300),
    BandFilter("20m",  14.0, 14.35, 56, 47*2, 56, 2200, 2200),
    BandFilter("17m/15m", 18.068, 21.45, 39, 33*2, 39, 1800, 1800),
    BandFilter("12m/10m", 24.89, 29.7, 27, 24*2, 27, 1500, 1500),
  };
